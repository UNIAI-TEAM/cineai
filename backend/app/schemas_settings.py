...
class AdminModelSettingsOut(BaseModel):
    ...
    # 展示货币与汇率
    billing_display_currency: str = "VND"
    billing_cny_vnd: float = 3600.0
    billing_usd_cny: float = 7.0

    # 银行转账收款
    topup_bank_name: str = ""
    topup_bank_account: str = ""
    topup_bank_holder: str = ""
    topup_bank_bin: str = ""
    topup_order_expire_hours: int = 24
...
class AdminModelSettingsPatch(BaseModel):
    ...
    billing_display_currency: str | None = None
    billing_cny_vnd: float | None = None
    billing_usd_cny: float | None = None
    topup_bank_name: str | None = None
    topup_bank_account: str | None = None
    topup_bank_holder: str | None = None
    topup_bank_bin: str | None = None
    topup_order_expire_hours: int | None = None

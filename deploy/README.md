...
> 开源仓库以根目录 [README.md](../README.md) 的 Docker 全栈为准。  
> 现网机器发布手册 `docs/DEPLOY.md`、发版记录 `docs/releases/` 仅本机保留，不上库。  
> 本文仅描述 Postgres/Redis compose 与本机跑 API 的补充说明。**不要**用 OSS 上传前端 dist 代替站点发布。

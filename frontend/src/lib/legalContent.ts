    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '充值以银行转账方式进行，由平台核对到账后入账，转账本身由您的银行处理；大模型推理由上游模型服务商完成。我们仅向其提供完成服务所必需的数据，并要求其按约定保护信息。',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Top-ups are made by bank transfer and credited once the Platform confirms receipt. Arrival follows system records.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Top-ups are made by bank transfer and confirmed by the Platform; the transfer itself is handled by your bank. Model inference goes through upstream providers. We share only what is needed to complete the service.',
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Người dùng phải đăng ký bằng thông tin có thật, còn hiệu lực và chịu trách nhiệm về mọi hoạt động phát sinh từ tài khoản của mình.',
          'Người dùng có trách nhiệm bảo mật thông tin đăng nhập. Mọi thiệt hại do để lộ hoặc cho người khác dùng chung tài khoản do người dùng tự chịu.',
          'Khi phát hiện tài khoản bị sử dụng trái phép, vui lòng thông báo ngay cho chúng tôi qua trang Liên hệ.',
          'Chúng tôi có quyền hạn chế, tạm khoá hoặc đóng tài khoản có hành vi lạm dụng, gian lận hoặc vi phạm chính sách.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          'Tạo hoặc phát tán nội dung trái pháp luật, khiêu dâm, bạo lực, kích động thù hận, lừa đảo hoặc xâm phạm quyền và lợi ích hợp pháp của người khác.',
          'Tấn công hệ thống, thu thập dữ liệu tự động, tìm cách né tránh việc tính phí, lạm dụng API hoặc gây ảnh hưởng đến người dùng khác.',
          'Bán lại tài khoản khi chưa được phép, đăng ký tài khoản hàng loạt hoặc có hành vi khác làm ảnh hưởng đến việc vận hành công bằng của Nền tảng.',
        ],
      },
      {
        title: '6. Giới hạn trách nhiệm',
        paragraphs: [
          'Trong phạm vi pháp luật cho phép, chúng tôi không chịu trách nhiệm về việc gián đoạn dịch vụ hoặc mất dữ liệu do sự cố đường truyền, do dịch vụ của bên thứ ba bị gián đoạn hoặc do sự kiện bất khả kháng.',
          'Nội dung do AI tạo ra chỉ là công cụ hỗ trợ sáng tạo, không phải ý kiến tư vấn chuyên môn. Đối với thiệt hại trực tiếp hoặc gián tiếp phát sinh từ việc người dùng dựa vào nội dung được tạo ra, chúng tôi không chịu trách nhiệm vượt quá số phí dịch vụ người dùng đã thanh toán, trừ trường hợp pháp luật có quy định bắt buộc khác.',
        ],
      },
      {
        title: '7. Sửa đổi điều khoản và chấm dứt dịch vụ',
        paragraphs: [
          'Chúng tôi có thể sửa đổi Điều khoản dịch vụ này khi cần. Phiên bản sửa đổi được công bố tại trang này và căn cứ theo “ngày cập nhật”. Việc bạn tiếp tục sử dụng dịch vụ sau khi điều khoản được sửa đổi có nghĩa là bạn chấp nhận nội dung sửa đổi đó.',
          'Bạn có quyền ngừng sử dụng dịch vụ và yêu cầu xoá tài khoản bất cứ lúc nào. Chúng tôi cũng có quyền ngừng cung cấp dịch vụ nếu bạn vi phạm nghiêm trọng Điều khoản dịch vụ này.',
        ],
      },
      {
        title: '8. Liên hệ',
    ...
    sections: [
      {
        ...
        bullets: [
          'Thông tin tài khoản: email, tên hiển thị, ảnh đại diện và thông tin dùng để xác thực đăng nhập.',
          'Dữ liệu sử dụng: dự án, prompt, trạng thái các lần tạo nội dung, lịch sử công cụ, nội dung trong Kho tư liệu và các dữ liệu nghiệp vụ khác.',
          'Dữ liệu thanh toán: số dư, khoản tạm giữ, đơn nạp tiền và lịch sử tính phí theo lượng sử dụng (việc thanh toán do bên thứ ba xử lý, chúng tôi không lưu các thông tin thanh toán nhạy cảm như số thẻ ngân hàng đầy đủ).',
          'Dữ liệu kỹ thuật: địa chỉ IP, loại trình duyệt và thời điểm truy cập và các nhật ký cần thiết khác, dùng cho mục đích bảo mật và khắc phục sự cố.',
        ],
      },
      {
        title: '2. Mục đích sử dụng dữ liệu',
        bullets: [
          'Cung cấp, duy trì và cải thiện dịch vụ phim ngắn AI, video ngắn AI và các công cụ.',
          'Xác minh danh tính, tính phí, tra cứu đơn nạp tiền và hỗ trợ người dùng.',
          'Bảo đảm an toàn cho tài khoản và hệ thống, phòng chống gian lận và lạm dụng.',
          'Gửi thông báo về dịch vụ hoặc cập nhật sản phẩm khi bạn đồng ý hoặc khi pháp luật cho phép.',
        ],
      },
      {
        title: '3. Lưu trữ dữ liệu và bên thứ ba',
        paragraphs: [
          'Hình ảnh, video và tệp dự án có thể được lưu trên dịch vụ lưu trữ đám mây (ví dụ Alibaba Cloud OSS) để phục vụ việc xem trước và tải xuống.',
          'Người dùng nạp tiền bằng chuyển khoản ngân hàng và khoản nạp do Nền tảng xác nhận, còn giao dịch chuyển khoản do ngân hàng của bạn thực hiện. Việc tạo nội dung bằng AI được thực hiện thông qua nhà cung cấp mô hình. Chúng tôi chỉ cung cấp cho các bên này những dữ liệu cần thiết để hoàn thành dịch vụ và yêu cầu họ bảo vệ thông tin theo thoả thuận.',
          'Chúng tôi không bán dữ liệu cá nhân của bạn cho bên thứ ba không liên quan, trừ trường hợp pháp luật yêu cầu, bạn đã đồng ý rõ ràng, hoặc cần thiết để bảo vệ quyền và lợi ích hợp pháp của Nền tảng và người dùng.',
        ],
      },
      {
        title: '4. Cookie và bộ nhớ trình duyệt',
        paragraphs: [
          'Chúng tôi có thể dùng cookie hoặc bộ nhớ của trình duyệt (ví dụ token đăng nhập) để giữ trạng thái đăng nhập và ghi nhớ các tuỳ chọn của bạn. Nếu xoá các dữ liệu này, bạn có thể phải đăng nhập lại.',
        ],
      },
      {
        title: '5. Quyền của người dùng',
        bullets: [
          'Xem và chỉnh sửa thông tin cá nhân tại trang Tài khoản.',
          'Xuất hoặc tải xuống các nội dung đã tạo mà bạn có quyền truy cập, trong phạm vi tính năng sản phẩm cho phép.',
          'Yêu cầu xoá tài khoản. Sau khi tài khoản bị xoá, chúng tôi sẽ xoá hoặc ẩn danh dữ liệu cá nhân theo quy định, trừ những dữ liệu pháp luật yêu cầu phải lưu giữ.',
          'Gửi câu hỏi hoặc khiếu nại liên quan đến quyền riêng tư.',
        ],
      },
      {
        title: '6. Người chưa thành niên',
        paragraphs: [
          'Nền tảng chủ yếu dành cho người dùng có năng lực hành vi dân sự đầy đủ. Nếu bạn là người chưa thành niên, vui lòng đọc chính sách này và sử dụng dịch vụ dưới sự hướng dẫn của người giám hộ.',
        ],
      },
      {
        title: '7. Cập nhật chính sách',
        paragraphs: [
          'Chúng tôi có thể cập nhật chính sách này và công bố phiên bản mới nhất kèm ngày cập nhật tại đây. Với những thay đổi quan trọng, chúng tôi sẽ cố gắng thông báo cho bạn qua thông báo trong sản phẩm hoặc hình thức khác.',
        ],
      },
      {
        title: '8. Liên hệ',

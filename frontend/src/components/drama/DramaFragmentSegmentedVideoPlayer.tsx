    ...
    <div className="drama-ep-segmented-player">
        ...
        {hasCurrentVideo ? (
          <>
            ...
            <div className="drama-ep-video-overlay-actions">
              <button
                type="button"
                aria-label={isFullscreen ? t('dramaEpisode.player.exitFullscreen') : t('dramaEpisode.player.fullscreen')}
              ...
              <button
                type="button"
                aria-label={t('dramaEpisode.player.downloadVideo')}
                className="drama-ep-video-overlay-btn"
          ...
          <img src={posterUrl} alt={t('dramaEpisode.player.posterAlt')} />
        ) : (
          <div className="drama-ep-player-placeholder">
            <span>{t('dramaEpisode.player.videoPending')}</span>
          </div>
        )}
      </div>
      ...
      <div className="drama-ep-video-controls">
        ...
        <div className="drama-ep-video-toolbar">
          <button
            type="button"
            aria-label={isPlaying ? t('dramaEpisode.player.pause') : t('dramaEpisode.player.play')}
          ...
          <button
            type="button"
            aria-label={autoLinkNext ? t('dramaEpisode.player.autoLinkOff') : t('dramaEpisode.player.autoLinkOn')}
            title={
              autoLinkNext ? t('dramaEpisode.player.autoLinkOff') : t('dramaEpisode.player.autoLinkTitle')
            }
          ...
          <button
            type="button"
            aria-label={muted ? t('dramaEpisode.player.unmute') : t('dramaEpisode.player.mute')}
            disabled={!hasCurrentVideo}
          ...
          <button
            type="button"
            aria-label={isFullscreen ? t('dramaEpisode.player.exitFullscreen') : t('dramaEpisode.player.fullscreen')}
            title={isFullscreen ? t('dramaEpisode.player.exitFullscreen') : t('dramaEpisode.player.fullscreen')}
            disabled={!hasCurrentVideo}
            className="drama-ep-video-icon-btn"
            onClick={() => void handleToggleFullscreen()}
          >

...
export const enStudio = {
  studioCreate: {
    ...
    overLimitTheme: "Over this language's {limit}-character topic limit. Shorten it to continue.",
    overLimitTitle: "Over this language's {limit}-character title limit. Shorten it to continue.",
    fitToLimit: 'Trim to fit',

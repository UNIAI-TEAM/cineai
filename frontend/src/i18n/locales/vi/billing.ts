...
export const viBilling = {
  billing: {
    ...
    alertMessage: 'Tổng chi tiêu của bạn đã vượt mốc {milestone} (hiện đã trừ {total}). Hãy để ý số dư tài khoản nhé.',
    alertMessageShort: 'Tổng chi tiêu của bạn đã vượt mốc {milestone}. Hãy để ý số dư tài khoản nhé.',
    ...
    records: {
      ...
      context: {
        drama: 'Phim ngắn · {title}',
        dramaProject: 'Phim ngắn · Dự án #{id}',
        kepu: 'Video ngắn · {title}',
        kepuProject: 'Video ngắn · Dự án #{id}',
        tool: 'Công cụ',
      },
    },
  },

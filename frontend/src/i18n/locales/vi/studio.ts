...
export const viStudio = {
  studioCreate: {
    ...
    overLimitTheme: 'Chủ đề vượt giới hạn {limit} ký tự của ngôn ngữ này. Hãy rút gọn để tiếp tục.',
    overLimitTitle: 'Tên dự án vượt giới hạn {limit} ký tự của ngôn ngữ này. Hãy rút gọn để tiếp tục.',
    fitToLimit: 'Cắt cho vừa',
  ...
  studioStyle: {
    ...
    imageModelHint: 'Các mô hình tạo ảnh chúng tôi đã bật cho video kiến thức.',
    recommended: 'Đề xuất',

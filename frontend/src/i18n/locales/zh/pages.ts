...
export const zhPages = {
  ...
  help: {
    ...
    faq: [
      ...
      {
        q: '如何充值？余额怎么扣？',
        a: '打开「定价」选择充值档位，按页面显示的收款账户银行转账，备注填写订单号，管理员核对后入账；未登录会先引导登录。按实际调用量扣费，余额永久有效，无强制订阅。用量可在定价页或个人中心「订阅与余额」查看。',
      },
      {
        q: '生成失败或画面不符合预期怎么办？',
  ...
  pricing: {
    ...
    featInstant: '管理员确认到账后即时可用',
    featSafe: '银行转账，安全可靠',
    featForever: '余额永久有效',
    guestPrefix: '',
    guestLogin: '登录',
    guestSuffix: ' 后查看余额与本月用量',
    paidHint: '转账已确认。若余额未更新，请稍候刷新本页。',
    paidOk: '到账已确认，余额已更新',
    orderFailed: '下单失败',
    recommended: '推荐',
    chooseAmount: '选择充值金额',
    currency: '展示货币',
    bankTransfer: '银行转账',
    bankTransferHint: '选择档位后显示收款账户，转账时备注填写订单号，管理员核对后自动入账',
    topupClosed: '充值暂未开放：收款账户尚未配置，请稍后再试或联系客服',
    credit: '到账',
    bonus: '额外赠送 {amount}',
    bonusPct: '+{pct}%',
    foreverHint: '余额永久有效',
  ...
  dramaList: {
    ...
    openAria: '打开 {title}',
    badgeCanvas: '自由画布',
    badgeCoverPending: '封面生成中',
    badgeNoImage: '待出图',
    usageTitle: '本剧累计费用与生成次数',
    selectedCount: '已选择 {count} 个项目',
    cancelSelect: '取消选择',
    deleting: '删除中…',
    moreActions: '更多操作',
    rename: '重命名',
    metaCanvas: '自由画布 · {assets} 节点资产',
    metaScript: '已写剧本 · {episodes} 集 · {assets} 资产',
    metaDraft: '草稿 · 待写剧本 · {assets} 资产',
    usageImages: '生图 {count}',
    usageVideos: '生视频 {count}',
    usageCalls: '调用 {count}',
    episodes: '{count} 集',
    episodeCountTitle: '自定义集数',
    episodeCustom: '自定义集数',
    episodeConfirm: '确定',
  },
  dramaStyle: {
